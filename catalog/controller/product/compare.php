...
echo "2018-06-18 d5 - catalog/controller/product/compare.php in \$this->session->data['compare'] array unsetting key named '$key' . . .<br />\n";
...
echo "2018-06-18 - catalog/controller/product/compare.php just set \$data to:<br />\n";
