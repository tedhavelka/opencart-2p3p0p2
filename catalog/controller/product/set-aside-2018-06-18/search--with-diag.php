...
// 2018-06-18 - Ted amending $products to hold quantity from database query:
					'quantity'    => $result['quantity']

echo "2018-06-18 d6 - catalog/controller/common/search.php search result \$result holds:<br />\n";
